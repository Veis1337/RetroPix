  ...
  return (
    <div className="home-page">
      <div className="content">
        ...
        <p className="description">
          Explore a vibrant community of artists, vote on their creations, and engage in discussions by leaving comments. Get inspired, learn from others, and showcase your pixel art skills!
        </p>
